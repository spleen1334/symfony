...
use Spleen\MagazineBundle\Entity\Issue;
use Spleen\MagazineBundle\Form\IssueType;
...
class IssueController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SpleenMagazineBundle:Issue')->findAll();
     ...
     * @Method("POST")
     * @Template("SpleenMagazineBundle:Issue:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SpleenMagazineBundle:Issue')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("SpleenMagazineBundle:Issue:edit.html.twig")
     */
