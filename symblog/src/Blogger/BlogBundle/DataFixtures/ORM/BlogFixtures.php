...
// use Doctrine\Common\DataFixtures\FixtureInterface; // ovo je zamenjeno sa AbstarctFixture 
...
class BlogFixtures extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        // Ovde se vrsi povezivanje fixtures putem referenci, tako da mozemo da se nadovezemo na blog1 iz comments fixture
    ...
    // Redosled ucitavanja fixture, Blog je glavni mora prvi pre Comments
