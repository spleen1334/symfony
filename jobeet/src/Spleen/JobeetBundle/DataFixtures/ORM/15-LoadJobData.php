<?php
namespace Spleen\JobeetBundle\DataFixtures\ORM;
...
class LoadJobData extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $em)
    {
        ...
        $job_sensio_labs->setCategory($em->merge($this->getReference('category-programming'))); // MERGE je zbog reference
        ...
        $job_extreme_sensio->setCategory($em->merge($this->getReference('category-design'))); // MERGE je zbog reference
